...
import RoomList from "./component/room_list";
import Description from "./component/description";
import Property from "./component/property";
import Amenities from "./component/amenities";
import Contact from "./component/contact";
import AditionalProperties from "./component/aditional_property";
import GuestReviews from "./component/guest_rewiews";
...
function App() {
   ...
   return (
      <Page>
         ...
         <RoomList types={data.roomTypes} title={"Типи номерів"} />

         <Description title="Опис" children={data.description} />

         <Property data={data.property_details} />
         ...
         <GuestReviews reviews={data.guestReviews} title={"Відгуки клієнтів"} />

         <Nearby data={data.nearbyAttractions} />
      </Page>
   );
}
